...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-desktop-update': { kind: 'none', reason: 'Browser-side desktop update presentation; it registers no model-facing input.' },
  'packages/client/ui-teacher-workbench': { kind: 'indirect', reason: 'The browser workbench invokes Host-owned operations; Host Consumers own every model-facing effect.' },
  ...
  'packages/util/concurrency': { kind: 'indirect', reason: 'The scheduler only bounds consumer work; each Consumer owns its model requests and rendered results.' },
  ...
  'packages/ocr/ocr': { kind: 'indirect', reason: 'The extraction service delegates model rendering to read_document and domain Consumers.' },
  'packages/ocr/ocr-mineru': { kind: 'indirect', reason: 'The provider delegates every model-visible use of extracted content to OCR Consumers.' },
  'packages/speech/speech': { kind: 'none', reason: 'The service returns transient user-owned draft text and registers no model-facing input.' },
  'packages/speech/speech-model-settings': { kind: 'none', reason: 'The provider returns transient transcription text only; Consumers own any later submission.' },
  ...
  'packages/client/ui-image-generation': { kind: 'none', reason: 'Browser-side presentation of existing image-generation result metadata; registers no model-facing input.' },
  ...
  'packages/client/ui-settings-models': { kind: 'indirect', reason: 'The Session Controller owns automatic model-verification requests.' },
  ...
  'packages/settings/model-service-settings': { kind: 'indirect', reason: 'The namespace stores typed request routing metadata; capability Consumers own any model-visible use of the selected route.' },
  ...
  'packages/skill/skill-ppt-master': { kind: 'indirect', reason: 'The bundled provider delegates model rendering to dsh-tool-skill.' },
