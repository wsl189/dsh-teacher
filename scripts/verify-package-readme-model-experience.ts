...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-teacher-workbench': { kind: 'indirect', reason: 'The timetable import action invokes the Host-owned normalization child; the Host package owns its model-visible request.' },
  ...
  'packages/ocr/ocr': { kind: 'indirect', reason: 'The extraction runtime delegates model rendering to browser Consumers such as ui-conversation.' },
  'packages/ocr/ocr-mineru': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-ocr Consumers.' },
