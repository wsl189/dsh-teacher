...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-teacher-workbench': { kind: 'none', reason: 'Browser-side teacher operations surface; records never enter model context.' },
  ...
  'packages/host/teacher-workbench': { kind: 'none', reason: 'Host-side GUI record persistence; records never enter model context.' },
