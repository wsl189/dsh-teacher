...
/** Generated descriptor/codec contribution with no shared runtime identity. */`,
  ...
  {
    // The step-1 file tree distinguishes the upstream copy from the
    // publishable, rescoped release member.
  ...
  {
    // The checklist rescopes the name while preserving upstream module metadata.
