...
describe('maintained repository reference policy', () => {
  ...
  it('excludes only ignored new files, vendored sources, frozen notes, and deleted files', (test) => {
    ...
    fixture.write('packages/skill/skill-ppt-master/assets/ppt-master/icons/source.svg', fixture.commit)
  ...
  it('accepts distinct organization names and excludes the frozen and vendored paths', () => {
    ...
    expect(findRepositoryReferences('packages/skill/skill-ppt-master/src/index.ts', organizationUrl, new Set()))
      .toEqual([{ file: 'packages/skill/skill-ppt-master/src/index.ts', line: 1, kind: 'organization-url' }])
