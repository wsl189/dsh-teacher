...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  mobileNotifications: 'optional extension-contributed notification service — docs/subsystems/teacher-workbench.md owns the consumer-facing API',
}
...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  'sessions/navigate': 'client-face Session navigation signal — packages/api/session-controller/README.md owns the API',
}
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  TeacherExample: 'teacher-workbench.md',
  TeacherExampleCatalog: 'teacher-workbench.md',
  TeacherExampleDocument: 'teacher-workbench.md',
  TeacherExampleDocumentKind: 'teacher-workbench.md',
  TeacherExampleDocumentRequest: 'teacher-workbench.md',
  TeacherExampleExportLayout: 'teacher-workbench.md',
  TeacherExampleExportRequest: 'teacher-workbench.md',
  TeacherExampleFile: 'teacher-workbench.md',
  TeacherExampleFileRequest: 'teacher-workbench.md',
  TeacherExampleId: 'teacher-workbench.md',
  TeacherExampleRequest: 'teacher-workbench.md',
  TeacherExampleResult: 'teacher-workbench.md',
  TeacherExampleUpdateRequest: 'teacher-workbench.md',
  TeacherExampleUploadRequest: 'teacher-workbench.md',
  TeacherExampleWordEditor: 'teacher-workbench.md',
  TeacherExampleWordSaved: 'teacher-workbench.md',
  TeacherExampleWordSaveRequest: 'teacher-workbench.md',
  TeacherQuestionAssignRequest: 'teacher-workbench.md',
  TeacherQuestionBatchDeleteRequest: 'teacher-workbench.md',
  TeacherQuestionBatchDocumentRequest: 'teacher-workbench.md',
  TeacherQuestionBatchDocumentResult: 'teacher-workbench.md',
  TeacherQuestionBatchSaveRequest: 'teacher-workbench.md',
  TeacherQuestionCropReviewRequest: 'teacher-workbench.md',
  ...
  TeacherQuestionImageReplaceRequest: 'teacher-workbench.md',
  TeacherQuestionMediaBrowseRequest: 'teacher-workbench.md',
  TeacherQuestionMediaBrowseResult: 'teacher-workbench.md',
  TeacherQuestionMediaDirectoryCreateRequest: 'teacher-workbench.md',
  TeacherQuestionMediaDirectoryDeleteRequest: 'teacher-workbench.md',
  TeacherQuestionMediaDirectoryRenameRequest: 'teacher-workbench.md',
  TeacherQuestionMutationResult: 'teacher-workbench.md',
  TeacherQuestionSegmentRequest: 'teacher-workbench.md',
  TeacherQuestionSegmentResult: 'teacher-workbench.md',
  TeacherQuestionTemporaryListRequest: 'teacher-workbench.md',
  TeacherQuestionTemporaryListResult: 'teacher-workbench.md',
  TeacherQuestionTemporarySaveRequest: 'teacher-workbench.md',
  TeacherQuestionTemporarySaveResult: 'teacher-workbench.md',
  TeacherQuestionUploadedDocumentRequest: 'teacher-workbench.md',
  TeacherScheduledReminderTask: 'teacher-workbench.md',
  TeacherTimetableNormalizeRequest: 'teacher-workbench.md',
  TeacherTimetableNormalizeResult: 'teacher-workbench.md',
  TeacherWeatherRequest: 'teacher-workbench.md',
  TeacherWeatherResult: 'teacher-workbench.md',
  TeacherWorkbenchReadRequest: 'teacher-workbench.md',
  TeacherWorkbenchReadResult: 'teacher-workbench.md',
  TeacherWorkbenchSourceConfig: 'teacher-workbench.md',
  TeacherWorkbenchSourceStageRequest: 'teacher-workbench.md',
  TeacherWorkbenchSourceStageResult: 'teacher-workbench.md',
  TeacherWorkbenchWriteRequest: 'teacher-workbench.md',
  TeacherWorkbenchWriteResult: 'teacher-workbench.md',
  ModelCheckRequest: 'session.md',
  ModelCheckResult: 'session.md',
