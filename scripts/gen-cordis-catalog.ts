...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  mobileNotifications: 'interface-typed optional service supplied by the out-of-tree dsh-im plugin — packages/host/teacher-workbench/README.md owns the consumed API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  TeacherTimetableNormalizeRequest: 'storage.md',
  TeacherTimetableNormalizeResult: 'storage.md',
  ...
  TeacherQuestionMediaBrowseRequest: 'storage.md',
  TeacherQuestionMediaBrowseResult: 'storage.md',
  TeacherQuestionMediaDirectoryCreateRequest: 'storage.md',
  TeacherQuestionMediaDirectoryDeleteRequest: 'storage.md',
  TeacherQuestionMediaDirectoryRenameRequest: 'storage.md',
  ...
  TeacherNotificationTarget: 'storage.md',
  TeacherScheduledReminderTask: 'storage.md',
  ...
  TeacherWorkbenchSourceConfig: 'storage.md',
  TeacherWorkbenchSourceStageRequest: 'storage.md',
