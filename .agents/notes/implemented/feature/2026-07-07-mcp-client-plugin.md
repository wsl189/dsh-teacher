...
[Tool-correlated sampling](../architecture/2026-09-16-official-release-integration.md) adds explicit, bounded auxiliary model access for opted-in tool invocations. Resources and Prompts remain outside this bridge.
