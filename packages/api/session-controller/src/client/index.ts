...
declare module '@deepseek-ai/cordis' {
  ...
  interface Events {
    /**
     * Explicit primary-Session navigation, including reselect and clear.
     * @mode emit
     * @param sessionId - selected Session, or undefined after clear.
     */
    'sessions/navigate'(sessionId: import('@deepseek-ai/dsh-session/types').SessionId | undefined): void
  }
}
