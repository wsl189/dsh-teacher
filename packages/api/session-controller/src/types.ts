...
declare module '@deepseek-ai/dsh-typert-protocol' {
  interface RemoteErrorDetailsMap {
    /** Saved model connection check failed; the message carries the provider diagnostic. */
    'session/model-check-failed': { readonly provider: string; readonly model: string }
...
export interface SessionPromptRequest {
  ...
  readonly contexts?: readonly PromptDocumentContext[]
