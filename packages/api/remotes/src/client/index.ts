...
export type * from '@deepseek-ai/dsh-host-teacher-workbench/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, pluginManagerRemote, teacherWorkbenchRemote, messageFeedbackRemote, ocrRemote, speechRemote,
      sessionFeedbackRemote, fileUploadsRemote, sessionReferencesRemote, permissionPresetsRemote,
      subagentsRemote, sessionRemote, workspaceRemote, workspaceFilesRemote, terminalRemote, officeToPdfRemote,
    ]) {
