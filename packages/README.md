...
| [`speech/`](speech/README.md) | Browser speech-transcription seam and QQ-configured provider | Product — stable API |
...
| [`util/`](util/README.md) | Low-level zero-dependency utilities shared across groups (`Branded<B>`, Harness home/path helpers, concurrency, timeout, retention) | Support — small, stable, harness-dep-free |
