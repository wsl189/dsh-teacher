...
| [`speech/`](speech/README.zh.md) | 浏览器语音转写能力与 QQ 配置提供方 | 产品：稳定 API |
...
| [`util/`](util/README.zh.md) | 组间共享的低层零依赖工具（`Branded<B>`、Harness home／路径辅助函数、并发、超时、留存） | 支持：小型、稳定、无 harness 依赖 |
