...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-image-generation ImageGenerationResultNode',
  ...
  },
  {
    ...
    source: 'packages/client/ui-settings-models/src/client/slot-contract.ts:47',
  },
  {
  ...
  {
    key: 'settings.models.specialized-model',
    kind: 'list',
    scope: 'root',
    summary: 'Ordered product-owned configuration area in Service access.',
    doc: 'Ordered product-owned configuration area in Service access. Without a\nregistrant the area renders nothing.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'settings.models.specialized-model\', () => ctx.slots.register(\n      { name: \'settings.models.specialized-model\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Official global panel icons.',
    doc: 'Official global panel icons.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Workbench entries between the brand row and workspace browser.',
    doc: 'Workbench entries between the brand row and workspace browser.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
