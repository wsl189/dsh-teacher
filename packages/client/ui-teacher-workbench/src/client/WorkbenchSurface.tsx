...
export function WorkbenchSurface(props: WorkbenchSurfaceProps) {
  ...
  const commands: TeacherWorkbenchCommands = {
    ...
    browseQuestionMedia: props.browseQuestionMedia,
    createQuestionMediaDirectory: props.createQuestionMediaDirectory,
    deleteQuestionMediaDirectory: props.deleteQuestionMediaDirectory,
    renameQuestionMediaDirectory: props.renameQuestionMediaDirectory,
