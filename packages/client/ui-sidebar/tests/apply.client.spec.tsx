...
describe('ui-sidebar apply', () => {
  ...
  it('registers the shell and declares its child seats', async () => {
    ...
    expect(b.slots.spec('sidebar.primary.section')).toEqual({ kind: 'list', scope: 'root' })
    expect(b.slots.spec('sidebar.workspaces')).toEqual({ kind: 'single', scope: 'root' })
    expect(b.slots.spec('sidebar.settings')).toEqual({ kind: 'single', scope: 'root' })
    expect(b.slots.spec('sidebar.update')).toEqual({ kind: 'single', scope: 'root' })
  ...
  it('removes the entry and child declaration on teardown', async () => {
    ...
    expect(b.slots.spec('sidebar.primary.section')).toBeUndefined()
    expect(b.slots.spec('sidebar.workspaces')).toBeUndefined()
    expect(b.slots.spec('sidebar.settings')).toBeUndefined()
    expect(b.slots.spec('sidebar.update')).toBeUndefined()
