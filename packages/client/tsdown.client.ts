...
export function clientBundle(
  ...
  return ({ env }) => {
    ...
    const client = clientConfig(id, clientEntry, options.clientAlias, options.clientBanner)
...
interface ClientBundleOptions {
  ...
  /** Browser-only dependency aliases for packages whose export conditions select a Node entry. */
...
function clientConfig(
  id: string, entry: string, alias: Readonly<Record<string, string>> | undefined,
