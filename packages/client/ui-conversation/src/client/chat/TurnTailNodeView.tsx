...
export const TurnTailNodeView = memo(function TurnTailNodeView({
  node, openFile, previewFile, forkAt, renderSlot, renderSlotChain, t, useSession,
  ...
  const owner: TurnTailOwnerProps = { turn, seq: closing?.finalNode.seq ?? data.seq, openFile, previewFile }
