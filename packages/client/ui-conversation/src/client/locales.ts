...
export const zh = {
  ...
  'image.dropTitle': '将图片或文档拖到此处即可添加',
  'image.dropDesc': '图片最多 {count} 张，每张 {size}；文档支持 PDF、Word、Excel 和 PPT',
  ...
  'document.extracting': '正在识别 {count} 个文档…',
  'document.unavailable': '文档识别服务不可用',
  'document.extractFailed': '文档识别失败：{message}',
...
export const en = {
  ...
  'image.dropTitle': 'Drop images or documents to add them',
  'image.dropDesc': 'Up to {count} images, {size} each; PDF, Word, Excel, and PPT documents are supported',
  ...
  'document.attach': 'Add image or document',
  'document.extracting': 'Extracting {count} document(s)…',
  'document.unavailable': 'Document extraction is unavailable',
  'document.extractFailed': 'Document extraction failed: {message}',
