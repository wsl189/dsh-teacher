...
import type { ConversationOcrRemote, ConversationWorkbenchRemote } from '../src/client/service.ts'
import { zh } from '../src/client/locales.ts'

const unusedOcr: ConversationOcrRemote = {
  extract: () => Promise.reject(new Error('OCR must not run in this bench')),
}
const unusedWorkbench: ConversationWorkbenchRemote = {
  stageSource: () => Promise.reject(new Error('workbench staging must not run in this bench')),
}
