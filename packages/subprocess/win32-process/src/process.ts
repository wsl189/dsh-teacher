...
interface ProcessSpawnOptions {
  /** Request a hidden initial window when the embedding desktop has no console. */
  hideWindow?: boolean
...
export function spawnPipedProcess(
  ...
  try {
    ...
    encodeStartupInfo(startupInfo, {
      ...
      dwFlags: abi.STARTF_USESTDHANDLES | (options.hideWindow === true ? abi.STARTF_USESHOWWINDOW : 0),
