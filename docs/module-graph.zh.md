...
flowchart TD
  ...
  subgraph group_deliverables["packages/deliverables"]
    pkg_office_workspace["office-workspace"]
  ...
  pkg_office_workspace --> pkg_agent
  pkg_office_workspace --> pkg_sandbox_policy
  pkg_office_workspace --> pkg_session
  pkg_office_workspace --> pkg_session_projection
  pkg_office_workspace --> pkg_tool_present
  pkg_office_workspace --> pkg_tools
...
| [`concurrency`](../packages/util/concurrency) | `util` | — |
...
| [`client-ui-image-generation`](../packages/client/ui-image-generation) | `client` | — |
...
| [`client-ui-teacher-workbench`](../packages/client/ui-teacher-workbench) | `client` | — |
...
| [`ocr`](../packages/ocr/ocr) | `ocr` | [`llm`](../packages/llm/llm), [`typert-protocol`](../packages/typert/protocol) |
| [`speech`](../packages/speech/speech) | `speech` | [`typert-protocol`](../packages/typert/protocol) |
...
| [`skill-ppt-master`](../packages/skill/skill-ppt-master) | `skill` | [`home-paths`](../packages/util/home-paths), [`skill`](../packages/skill/skill) |
...
| [`ocr-mineru`](../packages/ocr/ocr-mineru) | `ocr` | [`ocr`](../packages/ocr/ocr), [`settings`](../packages/settings/settings) |
...
| [`model-service-settings`](../packages/settings/model-service-settings) | `settings` | [`settings`](../packages/settings/settings) |
...
| [`speech-model-settings`](../packages/speech/speech-model-settings) | `speech` | [`agent-default-model`](../packages/core/agent-default-model), [`credentials`](../packages/credentials/credentials), [`model-service-settings`](../packages/settings/model-service-settings), [`settings`](../packages/settings/settings), [`speech`](../packages/speech/speech) |
...
| [`tool-fs`](../packages/fs/tool-fs) | `fs` | [`attachment`](../packages/attachment/attachment), [`fs`](../packages/fs/fs), [`llm`](../packages/llm/llm), [`ocr`](../packages/ocr/ocr), [`sandbox`](../packages/sandbox/sandbox), [`sandbox-policy`](../packages/sandbox/sandbox-policy), [`session`](../packages/core/session), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools), [`user-approval`](../packages/interaction/user-approval) |
...
| [`office-workspace`](../packages/deliverables/office-workspace) | `deliverables` | [`agent`](../packages/core/agent), [`sandbox-policy`](../packages/sandbox/sandbox-policy), [`session`](../packages/core/session), [`session-projection`](../packages/session/session-projection), [`tool-present`](../packages/deliverables/tool-present), [`tools`](../packages/core/tools) |
...
| [`mcp-client`](../packages/mcp/mcp-client) | `mcp` | [`attachment`](../packages/attachment/attachment), [`brand`](../packages/util/brand), [`llm`](../packages/llm/llm), [`mcp-resources`](../packages/mcp/mcp-resources), [`scope`](../packages/core/scope), [`session`](../packages/core/session), [`subprocess`](../packages/subprocess/subprocess), [`system-prompt`](../packages/core/system-prompt), [`timeout`](../packages/util/timeout), [`tools`](../packages/core/tools) |
...
| [`llm-replay`](../packages/test-support/llm-replay) | `test-support` | [`compaction`](../packages/compaction/compaction), [`deepseek-llm-api-extensions`](../packages/llm/deepseek-llm-api-extensions), [`llm`](../packages/llm/llm), [`mcp-client`](../packages/mcp/mcp-client), [`session`](../packages/core/session) |
...
| [`tool-teacher-workbench`](../packages/host/tool-teacher-workbench) | `host` | [`fs`](../packages/fs/fs), [`host-teacher-workbench`](../packages/host/teacher-workbench), [`tools`](../packages/core/tools) |
