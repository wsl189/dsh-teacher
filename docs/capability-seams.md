...
| `ctx.teacherWorkbench` | `core` | [`host-teacher-workbench`](../packages/host/teacher-workbench) | - | [`tool-teacher-workbench`](../packages/host/tool-teacher-workbench), [`client-ui-teacher-workbench`](../packages/client/ui-teacher-workbench) | - | Owns the revisioned teacher document, current-root question media, uploaded sources, reviewed segmentation, reminders, weather, and document-generation Remotes shared by browser and model-facing Consumers. |
...
| `ctx.skills` | `seam` | [`skill`](../packages/skill/skill) | [`skill-badge`](../packages/skill/skill-badge), [`skill-filesystem`](../packages/skill/skill-filesystem), [`skill-ppt-master`](../packages/skill/skill-ppt-master) | [`tool-skill`](../packages/skill/tool-skill) | - | Merges provider skill catalogs; tool-skill renders the session-prefix catalog and loads complete skill bodies. |
