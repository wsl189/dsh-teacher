...
Source: [`packages/core/agent-default-model/src/index.ts:69`](../packages/core/agent-default-model/src/index.ts)
...
Source: [`packages/settings/model-service-settings/src/index.ts:71`](../packages/settings/model-service-settings/src/index.ts)
...
Source: [`packages/skill/skill-ppt-master/src/index.ts:38`](../packages/skill/skill-ppt-master/src/index.ts)
...
Source: [`packages/speech/speech/src/index.ts:39`](../packages/speech/speech/src/index.ts)

<a id="deepseek-aidsh-speech-model-settings"></a>

## `@deepseek-ai/dsh-speech-model-settings`

Requires: `speech` · `agentDefaultModel` · `settings` · `credentials`
...
Source: [`packages/speech/speech-model-settings/src/index.ts:69`](../packages/speech/speech-model-settings/src/index.ts)
...
- `@deepseek-ai/dsh-office-workspace` — requires `tools` · `sessionProjections` · `sandboxPolicy` ([`packages/deliverables/office-workspace/src/index.ts`](../packages/deliverables/office-workspace/src/index.ts))
...
- `@deepseek-ai/dsh-tool-teacher-workbench` — requires `fs` · `tools` · `teacherWorkbench` ([`packages/host/tool-teacher-workbench/src/index.ts`](../packages/host/tool-teacher-workbench/src/index.ts))
