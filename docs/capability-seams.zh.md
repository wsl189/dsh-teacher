...
| `ctx.teacherWorkbench` | `core` | [`host-teacher-workbench`](../packages/host/teacher-workbench) | - | [`tool-teacher-workbench`](../packages/host/tool-teacher-workbench), [`client-ui-teacher-workbench`](../packages/client/ui-teacher-workbench) | - | 负责带修订号的教师文档、当前根目录试题媒体、上传来源、复核式分割、提醒、天气，以及浏览器和面向模型 Consumer 共用的文档生成 Remote。 |
...
| `ctx.skills` | `seam` | [`skill`](../packages/skill/skill) | [`skill-badge`](../packages/skill/skill-badge), [`skill-filesystem`](../packages/skill/skill-filesystem), [`skill-ppt-master`](../packages/skill/skill-ppt-master) | [`tool-skill`](../packages/skill/tool-skill) | - | 合并提供方的 skill（技能）目录；tool-skill 渲染会话前缀目录，并加载完整的 skill 正文。 |
