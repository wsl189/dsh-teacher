...
flowchart LR
  pkg_ocr["ocr"]
  svc_ocr["ctx.ocr<br/>Document extraction seam"]
  ...
  svc_teacherWorkbench["ctx.teacherWorkbench<br/>Durable teacher workbench domain"]
  ...
  svc_ocr --> pkg_host_teacher_workbench
  svc_ocr --> pkg_tool_fs
  ...
  svc_speech --> pkg_client_ui_conversation
  svc_speech --> pkg_client_ui_teacher_workbench
  ...
  svc_teacherWorkbench --> pkg_client_ui_teacher_workbench
  svc_teacherWorkbench --> pkg_tool_teacher_workbench
...
| --- | --- | --- | --- | --- | --- | --- |
| `ctx.ocr` | `seam` | [`ocr`](../packages/ocr/ocr) | [`ocr-mineru`](../packages/ocr/ocr-mineru) | [`tool-fs`](../packages/fs/tool-fs), [`host-teacher-workbench`](../packages/host/teacher-workbench) | - | 提供方将提取的 Markdown 和页面几何信息规范化；文件系统读取和教师题目切分负责这些结果的持久化或面向模型的用途。 |
| `ctx.speech` | `seam` | [`speech`](../packages/speech/speech) | [`speech-model-settings`](../packages/speech/speech-model-settings) | [`client-ui-conversation`](../packages/client/ui-conversation), [`client-ui-teacher-workbench`](../packages/client/ui-teacher-workbench) | - | 提供方通过 Host Remote 返回最终文本；浏览器 Consumer 在用户提交或保存之前将其保留为可编辑草稿。 |
| `ctx.teacherWorkbench` | `core` | [`host-teacher-workbench`](../packages/host/teacher-workbench) | - | [`tool-teacher-workbench`](../packages/host/tool-teacher-workbench), [`client-ui-teacher-workbench`](../packages/client/ui-teacher-workbench) | - | 拥有带修订号的教师文档、当前根目录下的题目媒体、上传来源、经确认的切分结果、提醒、天气，以及浏览器和面向模型的 Consumer 共用的文档生成 Remote。 |
