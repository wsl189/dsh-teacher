...
来源：[`packages/core/agent-default-model/src/index.ts:69`](../packages/core/agent-default-model/src/index.ts)
...
来源：[`packages/settings/model-service-settings/src/index.ts:71`](../packages/settings/model-service-settings/src/index.ts)
...
来源：[`packages/ocr/ocr/src/index.ts:54`](../packages/ocr/ocr/src/index.ts)
...
来源：[`packages/ocr/ocr-mineru/src/index.ts:97`](../packages/ocr/ocr-mineru/src/index.ts)
...
来源：[`packages/speech/speech-model-settings/src/index.ts:69`](../packages/speech/speech-model-settings/src/index.ts)
...
来源：[`packages/deliverables/tool-present/src/index.ts:28`](../packages/deliverables/tool-present/src/index.ts)
...
- `@deepseek-ai/dsh-office-workspace` — 需要 `tools` · `sessionProjections` · `sandboxPolicy` ([`packages/deliverables/office-workspace/src/index.ts`](../packages/deliverables/office-workspace/src/index.ts))
...
- `@deepseek-ai/dsh-tool-teacher-workbench` — 需要 `fs` · `tools` · `teacherWorkbench` ([`packages/host/tool-teacher-workbench/src/index.ts`](../packages/host/tool-teacher-workbench/src/index.ts))
